...
class JpaCommentRepositoryTest {
    ...
    public void initialize() {
        expectedComments = List.of(
                new Comment(2L, bookRepository.findById(3L).get(), "Very good"),
                new Comment(3L, bookRepository.findById(3L).get(), "Boring"));
    }
    ...
    void shouldSaveComment() {
        Comment comment = new Comment(0L, bookRepository.findById(1L).get(), "Some comment");
