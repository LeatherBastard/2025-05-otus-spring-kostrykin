...
public class BookServiceIntegrationTest {
    ...
    void shouldInsertBook() {
        ...
        assertThat(actualBook).usingRecursiveComparison().ignoringFields("id").isEqualTo(bookConverter.bookToDto(expectedBook));
    }
    ...
    void shouldUpdateBookById() {
        ...
        Book book = repository.save(new Book("Book", authors.get(0), List.of(genres.get(0), genres.get(1))));
        ...
        book.setGenres(List.of(genres.get(2), genres.get(3)));

        BookDto actualBookDto = bookService.update(book.getId(), updatedTitle, updatedAuthorId, updatedGenreIds);
        BookDto expectedBookDto = bookConverter.bookToDto(book);
